...
class FileSection extends StatelessWidget {
  ...
  const FileSection({super.key, required this.status, required this.order});
...
// class DeliveredFileSection extends StatelessWidget {
//   final String status;
//   final DeliveredOrderModel order;
//   const DeliveredFileSection(
...
//             ),
//             minVerticalPadding: 2.w,
//             // subtitle: Text("109kb __ PDF", style: AppText.regular15()),
//             trailing: IconButton(
//               onPressed: () async {
//                 FileService service = FileService();
//                 await service.downloadAndOpenFile(
//                   order.invoice ?? "",
//                   order.invoice ?? "",
//                   "${order.clientName}-${order.id}",
//                 );
